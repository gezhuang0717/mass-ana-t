...
**   Mit„ muutettu:    arvosana toimimaan my”s negatiivisilla arvoilla
**                     korjattu vika "«" -> 0
...
**   Mit„ muutettu:    isoksi ja pieneksi käsittelee sekä OEM että ANSI
...
**
** Tarkempi kuvaus kustakin aliohjelmasta l”ytyy tiedostosta mjonot.c.
**
** Kaikissa aliohjelmissa on varauduttu siihen, ett„ niit„ kutsutaan
** NULL osoittimella ja kukin niist„  yritt„„ toimia t„ll”in jotenkin
** j„rkev„sti.
**
*/
