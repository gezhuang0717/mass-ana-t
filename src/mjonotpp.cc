...
// Muistettava ett„ hakemistonkin nimessa voi olla .
// Esim: oma.dat => 3
//       0123456
//       c:\oma.1\oma => -1
{
  size_t i = tied.find_last_of(":.\\"); // Mik„ loytyy viimeisen„?
  if ( i == vstring::npos ) return -1;  // Jollei mikaan niin ei ole
  if ( tied[i] == '.' ) return i;       // Jos viimeinen oli . niin l”ytyi
...
// Lis„„ tarkentimen, mik„li sit„ ei viel„ ole
