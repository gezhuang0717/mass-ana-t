...
#GTKMM_PREFIX=/opt/gtkmm32
#ACE_PREFIX=/opt/ace-6.2.6/win32
...
git archive --format=tar HEAD . | (cd $TEMPDIR ; tar xfvp -)
...
mkdir -p build/gtk2
pushd build/gtk2
../../configure --with-gtkmm-version=gtkmm2
...
# mkdir -p build/gtk3
#pushd build/gtk3
#../../configure --with-gtkmm-version=gtkmm3
...
#../../configure --with-gtkmm-version=gtkmm2 --with-online
...
../../configure --with-gtkmm-version=gtkmm3 --with-online
